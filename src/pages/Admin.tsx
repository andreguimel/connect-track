    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="p-8 overflow-auto">
        ...
        <div className="grid gap-4 md:grid-cols-4 mb-8">
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between pb-2">
              <CardTitle className="text-sm font-medium">Aparelhos Conectados</CardTitle>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{totalMessages.toLocaleString('pt-BR')}</div>
            </CardContent>
          </Card>
                ...
                <TableBody>
                  {users.map((userStats) => (
                    <TableRow key={userStats.user_id}>
                      <TableCell>
                        <div>
                          <div className="font-medium">{userStats.full_name || 'Sem nome'}</div>
                      ...
                      <TableCell className="text-center">{userStats.devices_count}</TableCell>
                      <TableCell className="text-center">{userStats.messages_sent.toLocaleString('pt-BR')}</TableCell>
                      <TableCell className="text-center">{userStats.campaigns_count}</TableCell>
                      <TableCell>
